...
public class MnistMainTest {
    ...
    public void main() throws IOException {
        ...
        final Path baseDir = Paths.get("src", "test", "resources", "testMnistMain");
        try {
    ...
    private Main runNewMain(Path baseDir, int nrofEpochs) throws IOException {
        final Main main = Main.parseArgs("-nrofEpochs", String.valueOf(nrofEpochs), "-saveDir", baseDir.toString(), "odenet", "-stem", "conv", "-nrofKernels", "4");
    ...
    private static class DummyDataSetIterFactory implements DataSetIteratorFactory {
        ...
        public DataSetIterator create() {
            return new SingletonDataSetIterator(new DataSet(Nd4j.randn(new long[]{1, 1, 28, 28}), Nd4j.ones(1, 10)));
        }
    }
}
