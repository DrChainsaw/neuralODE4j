...
public class InterpolatingStepListenerTest {
    ...
    /**
     * Verify that the result from using an {@link InterpolatingStepListener} is equivalent to using a {@link MultiStepSolver}
     * for the same input.
     */
    @Test
    ...
    private static Pair<INDArray, INDArray> solveCircleMultiInterpol() {
        ...
        final INDArray expected = new MultiStepSolver(singleStepSolver).integrate(equation, t, y0, yMulti.dup()).transposei();
