...
public class ShapeMatchVertexTest {
    ...
    public void toStringTest() {
        ...
        final GraphVertex vertex = new ElementWiseVertex(null, vertexName + "-vertex", vertexIndex,
                ElementWiseVertex.Op.Add, DataType.FLOAT);
        final GraphVertex test = new ode.vertex.conf.ShapeMatchVertex(
                ...
                null, vertexName, vertexIndex, null, false, DataType.FLOAT);
    ...
    public void doBackward() {
        ...
        final GraphVertex vertex = new ShapeMatchVertex(null, "test", 1, DataType.FLOAT,
                new ElementWiseVertex(null, "test-vertex", 1, ElementWiseVertex.Op.Average, DataType.FLOAT), Collections.emptyMap());
